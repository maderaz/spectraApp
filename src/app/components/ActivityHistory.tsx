...
const ACTIVITIES: Activity[] = [
  ...
  { id: "13", type: "Swap",             pool: "avUSD",     protocol: "Avant",          tokenIn: "avUSDx",   tokenOut: "YT-avUSD",   amountIn: "3,500",    amountOut: "183,210.5", value: "$3,500",  time: "4d ago",     status: "Confirmed" },
  { id: "14", type: "Add Liquidity",    pool: "USDN",      protocol: "SMARDEX",        tokenIn: "WUSDN",    tokenOut: "LP-USDN",    amountIn: "22,000",   amountOut: "21,648.30", value: "$22,000", time: "5d ago",     status: "Confirmed" },
  { id: "15", type: "Swap",             pool: "vbUSDT",    protocol: "Yearn",          tokenIn: "USDT",     tokenOut: "PT-vbUSDT",  amountIn: "6,800",    amountOut: "7,021.44",  value: "$6,800",  time: "5d ago",     status: "Confirmed" },
  { id: "16", type: "Claim",            pool: "sGHO",      protocol: "Aave",           tokenIn: "—",        tokenOut: "SPECTRA",    amountIn: "—",        amountOut: "3,850.00",  value: "$1,155",  time: "6d ago",     status: "Confirmed" },
  { id: "17", type: "Swap",             pool: "WFLR",      protocol: "Sceptre",        tokenIn: "FLR",      tokenOut: "PT-sFLR",    amountIn: "125,000",  amountOut: "128,750",   value: "$3,437",  time: "1w ago",     status: "Confirmed" },
  { id: "18", type: "Remove Liquidity", pool: "avUSD",     protocol: "Avant",          tokenIn: "LP-avUSD", tokenOut: "avUSDx",     amountIn: "8,420.00", amountOut: "8,545.12",  value: "$8,545",  time: "1w ago",     status: "Confirmed" },
  { id: "19", type: "Swap",             pool: "yn-RWA/USD",protocol: "YieldNest",      tokenIn: "USDC",     tokenOut: "PT-STAK",    amountIn: "12,000",   amountOut: "12,384.00", value: "$12,000", time: "1w ago",     status: "Confirmed" },
  { id: "20", type: "Add Liquidity",    pool: "ETH",       protocol: "Ether.fi",       tokenIn: "weETH",    tokenOut: "LP-weETH",   amountIn: "5.00",     amountOut: "4.94",      value: "$12,850", time: "2w ago",     status: "Confirmed" },
  { id: "21", type: "Claim",            pool: "WFLR",      protocol: "Sceptre",        tokenIn: "—",        tokenOut: "rFLR",       amountIn: "—",        amountOut: "1,820.00",  value: "$655",    time: "2w ago",     status: "Confirmed" },
  { id: "22", type: "Swap",             pool: "sdCRV",     protocol: "Aladdin",        tokenIn: "CRV",      tokenOut: "PT-asdCRV",  amountIn: "18,500",   amountOut: "19,055.00", value: "$7,957",  time: "2w ago",     status: "Confirmed" },
  { id: "23", type: "Swap",             pool: "AVAX",      protocol: "Treehouse",      tokenIn: "AVAX",     tokenOut: "YT-tAVAX",   amountIn: "450",      amountOut: "61,650.00", value: "$11,250", time: "3w ago",     status: "Confirmed" },
  { id: "24", type: "Add Liquidity",    pool: "BOLD",      protocol: "Liquity V2",     tokenIn: "BOLD",     tokenOut: "LP-BOLD",    amountIn: "5,000",    amountOut: "4,925.50",  value: "$5,000",  time: "3w ago",     status: "Confirmed" },
];
