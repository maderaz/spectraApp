  ...
  return (
    <div className="flex flex-col h-full font-['Inter']">
      ...
      <div className="px-5 py-2.5">
        <button className="flex items-center gap-2 w-full bg-white/[0.04] rounded-[6px] px-3 py-[8px] hover:bg-white/10 transition-colors border border-white/[0.06]">
          ...
          return (
            <div key={section.key} className={sIdx > 0 ? "mt-3" : ""}>
              ...
              <div
                ...
                style={{
                  maxHeight: isCollapsible && isCollapsed ? 0 : section.items.length * 42,
      ...
      <div className="px-5 pb-4 pt-1.5 border-t border-white/[0.06] flex flex-col gap-0">
        <button
          ...
          className={`flex items-center gap-2 w-full px-2 py-[4px] hover:bg-white/10 active:bg-white/15 rounded-[6px] transition-colors text-left ${
            location.pathname === "/brand-components" ? "bg-white/10" : ""
          }`}
        >
        ...
        <button className="flex items-center gap-2 w-full px-2 py-[4px] hover:bg-white/10 active:bg-white/15 rounded-[6px] transition-colors text-left">
          <div className="shrink-0 w-5 h-5 flex items-center justify-center">
            <SettingsIcon />
          </div>
